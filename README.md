...
Installation can build a small C extension for telomere mismatch comparisons. It needs a C compiler and Python development headers; Cython and pysam headers are not required. If it cannot be built or imported, Telomerecat uses the existing Python implementation.
